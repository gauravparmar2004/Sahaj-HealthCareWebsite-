...
const Appointments = () => {
  ...
  return (
    docInfo && (
      <div className="bg-[#171F2D] p-10 pb-10 ">
        ...
        <div className="sm:ml-72 pt-7 sm:pl-4 mt-4 font-medium text-gray-200">
          <p>Booking Slots</p>
          ...
          <button className="bg-blue-500 text-white text-sm px-14 py-3 rounded-full my-6 cursor-pointer font-bold ">Book an appoinment</button>
        </div>
