        ...
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2 space-y-6">
            <h1 className="text-4xl sm:text-5xl font-bold text-white">
              Med.ai - Your AI <br /> Health Companion
            </h1>
            <p className="text-gray-300 text-lg">
              Personalized health insights powered by artificial intelligence
            </p>
            <div className="flex space-x-4">
              <button onClick={()=>navigate('/interactionpage')}  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md text-sm cursor-pointer">
                Get Started →
              </button>
